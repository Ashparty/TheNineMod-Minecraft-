...
public class PekoiumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:pekoium_block")
	public static final Block block = null;
	public PekoiumBlockBlock(TheNineModElements instance) {
		super(instance, 173);
	}
