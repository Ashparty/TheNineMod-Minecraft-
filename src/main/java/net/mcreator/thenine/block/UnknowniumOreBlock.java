...
import net.mcreator.thenine.item.UnknowniumItem;
...
public class UnknowniumOreBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:unknownium_ore")
	public static final Block block = null;
	public UnknowniumOreBlock(TheNineModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unknownium_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UnknowniumItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("unknownium_ore", "unknownium_ore", blockAt -> {
