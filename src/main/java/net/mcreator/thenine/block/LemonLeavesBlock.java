...
public class LemonLeavesBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:lemon_leaves")
	public static final Block block = null;
	public LemonLeavesBlock(TheNineModElements instance) {
		super(instance, 68);
	}
