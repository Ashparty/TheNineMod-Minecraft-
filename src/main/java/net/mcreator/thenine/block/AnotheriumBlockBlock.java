...
public class AnotheriumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:anotherium_block")
	public static final Block block = null;
	public AnotheriumBlockBlock(TheNineModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("anotherium_block");
		}
