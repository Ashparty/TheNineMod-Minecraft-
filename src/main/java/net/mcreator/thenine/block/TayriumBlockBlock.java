...
public class TayriumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:tayrium_block")
	public static final Block block = null;
	public TayriumBlockBlock(TheNineModElements instance) {
		super(instance, 215);
	}
