...
public class CheliumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:chelium_block")
	public static final Block block = null;
	public CheliumBlockBlock(TheNineModElements instance) {
		super(instance, 299);
	}
