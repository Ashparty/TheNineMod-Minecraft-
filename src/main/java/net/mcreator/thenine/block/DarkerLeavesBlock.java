...
public class DarkerLeavesBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_leaves")
	public static final Block block = null;
	public DarkerLeavesBlock(TheNineModElements instance) {
		super(instance, 90);
	}
