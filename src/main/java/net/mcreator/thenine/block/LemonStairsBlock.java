...
public class LemonStairsBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:lemon_stairs")
	public static final Block block = null;
	public LemonStairsBlock(TheNineModElements instance) {
		super(instance, 69);
	}
