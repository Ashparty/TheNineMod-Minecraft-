...
public class DarkerStairsBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_stairs")
	public static final Block block = null;
	public DarkerStairsBlock(TheNineModElements instance) {
		super(instance, 91);
	}
