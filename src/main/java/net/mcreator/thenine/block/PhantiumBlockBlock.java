...
public class PhantiumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:phantium_block")
	public static final Block block = null;
	public PhantiumBlockBlock(TheNineModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("phantium_block");
		}
