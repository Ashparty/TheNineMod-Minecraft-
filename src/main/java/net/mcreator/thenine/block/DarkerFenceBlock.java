...
public class DarkerFenceBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_fence")
	public static final Block block = null;
	public DarkerFenceBlock(TheNineModElements instance) {
		super(instance, 93);
	}
