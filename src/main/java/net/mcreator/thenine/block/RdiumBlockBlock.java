...
public class RdiumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:rdium_block")
	public static final Block block = null;
	public RdiumBlockBlock(TheNineModElements instance) {
		super(instance, 194);
	}
