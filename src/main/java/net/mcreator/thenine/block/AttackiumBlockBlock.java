...
public class AttackiumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:attackium_block")
	public static final Block block = null;
	public AttackiumBlockBlock(TheNineModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("attackium_block");
		}
