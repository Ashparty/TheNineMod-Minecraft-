...
public class DarkerFenceGateBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_fence_gate")
	public static final Block block = null;
	public DarkerFenceGateBlock(TheNineModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("darker_fence_gate");
		}
