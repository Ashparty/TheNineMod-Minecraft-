...
public class LemonFenceGateBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:lemon_fence_gate")
	public static final Block block = null;
	public LemonFenceGateBlock(TheNineModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_fence_gate");
		}
