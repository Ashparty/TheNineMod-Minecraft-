...
public class DarkerWoodBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_wood")
	public static final Block block = null;
	public DarkerWoodBlock(TheNineModElements instance) {
		super(instance, 87);
	}
