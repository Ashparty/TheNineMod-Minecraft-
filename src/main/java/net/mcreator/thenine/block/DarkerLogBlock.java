...
public class DarkerLogBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_log")
	public static final Block block = null;
	public DarkerLogBlock(TheNineModElements instance) {
		super(instance, 88);
	}
