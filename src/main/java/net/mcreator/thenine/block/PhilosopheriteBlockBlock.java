...
public class PhilosopheriteBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:philosopherite_block")
	public static final Block block = null;
	public PhilosopheriteBlockBlock(TheNineModElements instance) {
		super(instance, 341);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("philosopherite_block");
		}
