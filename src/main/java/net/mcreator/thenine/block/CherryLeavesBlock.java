...
public class CherryLeavesBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:cherry_leaves")
	public static final Block block = null;
	public CherryLeavesBlock(TheNineModElements instance) {
		super(instance, 23);
	}
