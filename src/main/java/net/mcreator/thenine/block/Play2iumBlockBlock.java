...
public class Play2iumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:play_2ium_block")
	public static final Block block = null;
	public Play2iumBlockBlock(TheNineModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("play_2ium_block");
		}
