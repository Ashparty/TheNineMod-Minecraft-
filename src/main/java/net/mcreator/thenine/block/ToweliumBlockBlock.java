...
public class ToweliumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:towelium_block")
	public static final Block block = null;
	public ToweliumBlockBlock(TheNineModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("towelium_block");
		}
