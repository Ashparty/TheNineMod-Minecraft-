...
public class CherryFenceBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:cherry_fence")
	public static final Block block = null;
	public CherryFenceBlock(TheNineModElements instance) {
		super(instance, 34);
	}
