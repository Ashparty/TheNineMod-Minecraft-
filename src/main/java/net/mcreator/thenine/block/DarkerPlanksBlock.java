...
public class DarkerPlanksBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_planks")
	public static final Block block = null;
	public DarkerPlanksBlock(TheNineModElements instance) {
		super(instance, 89);
	}
