...
public class FearlessiumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:fearlessium_block")
	public static final Block block = null;
	public FearlessiumBlockBlock(TheNineModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fearlessium_block");
		}
