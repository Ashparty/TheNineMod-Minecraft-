...
public class DarkerSlabBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:darker_slab")
	public static final Block block = null;
	public DarkerSlabBlock(TheNineModElements instance) {
		super(instance, 92);
	}
