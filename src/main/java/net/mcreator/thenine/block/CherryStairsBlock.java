...
public class CherryStairsBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:cherry_stairs")
	public static final Block block = null;
	public CherryStairsBlock(TheNineModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3f, 3f)).getDefaultState(),
					Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 3f).setLightLevel(s -> 0));
