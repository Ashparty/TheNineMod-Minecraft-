...
public class LemonPlanksBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:lemon_planks")
	public static final Block block = null;
	public LemonPlanksBlock(TheNineModElements instance) {
		super(instance, 67);
	}
