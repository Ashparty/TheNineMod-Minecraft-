...
public class UnknowniumBlockBlock extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:unknownium_block")
	public static final Block block = null;
	public UnknowniumBlockBlock(TheNineModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unknownium_block");
		}
