...
public class FreezingFusionTableTickProcedure extends TheNineModElements.ModElement {
	public FreezingFusionTableTickProcedure(TheNineModElements instance) {
		super(instance, 52);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(FreezingRiftOreBlock.block, (int) (1))
				.getItem()) && ((((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
