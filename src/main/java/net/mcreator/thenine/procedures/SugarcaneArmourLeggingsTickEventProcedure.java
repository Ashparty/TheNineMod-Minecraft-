...
public class SugarcaneArmourLeggingsTickEventProcedure extends TheNineModElements.ModElement {
	public SugarcaneArmourLeggingsTickEventProcedure(TheNineModElements instance) {
		super(instance, 373);
	}
