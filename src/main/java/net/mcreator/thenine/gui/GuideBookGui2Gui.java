...
public class GuideBookGui2Gui extends TheNineModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
			...
			Info.render(ms, mouseX, mouseY, partialTicks);
		}
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "Lol get trolled", 23, 45, -12829636);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 9, this.guiTop + 133, 65, 20, new StringTextComponent("previous"), e -> {
				TheNineMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			Info = new TextFieldWidget(this.font, this.guiLeft + 20, this.guiTop + 24, 120, 20, new StringTextComponent("Lololol get trolled")) {
				{
