...
public class LifeStealEnchantment extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:life_steal")
	public static final Enchantment enchantment = null;
	public LifeStealEnchantment(TheNineModElements instance) {
		super(instance, 378);
	}
