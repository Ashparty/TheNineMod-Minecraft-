...
import net.mcreator.thenine.procedures.AppleJuiceFoodEatenProcedure;
...
public class AppleJuiceItem extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:apple_juice")
	public static final Item block = null;
	public AppleJuiceItem(TheNineModElements instance) {
		super(instance, 386);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				AppleJuiceFoodEatenProcedure.executeProcedure($_dependencies);
			}
