...
public class SugarcaneArmourItem extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:sugarcane_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_nine:sugarcane_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_nine:sugarcane_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_nine:sugarcane_armour_boots")
	public static final Item boots = null;
	public SugarcaneArmourItem(TheNineModElements instance) {
		super(instance, 20);
	}
