...
public class GuideBookItem extends TheNineModElements.ModElement {
	@ObjectHolder("the_nine:guide_book")
	public static final Item block = null;
	public GuideBookItem(TheNineModElements instance) {
		super(instance, 370);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GuideBookguiGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(TheNineModItemGroup.tab).maxStackSize(1).rarity(Rarity.EPIC));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Right click to learn more about this mod!"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Guide Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GuideBookguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
